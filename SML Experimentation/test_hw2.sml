...
print("\n14.Range "^test(range, (20,2,~3), [20,17,14,11,8,5] )^"\n");
print("\n15.Slice "^test(slice, (range(2,20,2),2,7), [6,8,10,12,14])^"\n");
print("\n16.Slice "^test(slice, (range(1,100,4),3,12), [13, 17, 21, 25, 29, 33, 37, 41, 45])^"\n");
print("\n17.Binary Search "^test(binarySearch, ([1,3,21,52,54,61, 80,90,100],52), true)^"\n");
print("\n18.Binary Search "^test(binarySearch, ([1,3,21,52,54,61, 80,90,100],100), true)^"\n");
print("\n19.Binary Search "^test(binarySearch, ([1,3,21,52,54,61, 80,90,100],1), true)^"\n");
print("\n20.Binary Search "^test(binarySearch, ([1,3,21,52,54,61, 80,90],52), true)^"\n");
print("\n21.Binary Search "^test(binarySearch, ([1,3,21,52,54,61, 80,90],53), false)^"\n");
print("\n22.Binary Search "^test(binarySearch, ([1],1), true)^"\n");
